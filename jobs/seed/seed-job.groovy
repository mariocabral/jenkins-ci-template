...
if ( git_url ) {
  Logger.global.info("[Running] Using seed job from git url ")
  scm = """\
  ...
  Logger.global.info("[Running] Using seed job from svn url ")
  scm = """\
...
// CHK this need to be review later
Logger.global.info("[Running] Disable Security")
Jenkins.getInstance().disableSecurity()
Jenkins.instance.save()
Logger.global.info("[Running] Security changes saved")

Logger.global.info("[Running] Creation of seed job")
